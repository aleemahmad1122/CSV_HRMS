...
export class ApiCallingService {
  ...
  postData<T>(controllerName: string, methodName: string, body: any, showLoader: boolean, employeeId?: string): Observable<any> {
    ...
    const staticQueryParams = { companyId: this._localStorage.getCompanyDetail().companyId, employeeId: employeeId || this._localStorage.getEmployeeDetail()[0].employeeId };

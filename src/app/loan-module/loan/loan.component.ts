  ...
  private loadPermissions(): void {
    this.activatedRoute.data.subscribe(data => {
      ...
      if (Array.isArray(permissionsData)) {
        ...
        this.isEdit = this.permissions.some(p => p.permission === "Edit_Loan" && p.isAssign);
        this.isCreate = this.permissions.some(p => p.permission === "Apply_Loan" && p.isAssign);
        this.isDelete = this.permissions.some(p => p.permission === "Delete_Loan" && p.isAssign);
        this.isApproval = this.permissions.some(p => p.permission === "Loan_Approval" && p.isAssign);

...
export class AddEditModuleComponent implements OnInit, OnDestroy {
  ...
  private createForm(): FormGroup {
    return this.fb.group({
      image: [localStorage.getItem('empProImg')],
  ...
  private patchFormValues(): void {
    if (this.selectedValue) {
      this.addEditForm.patchValue({
        image: this.selectedValue.image,
        ...
        permanentAddress: this.selectedValue.permanentAddress,
        presentAddress: this.selectedValue.presentAddress,
      ...
      next: (response) => {
        if (response?.success) {
          ...
          if (!this.isEditMode) {
            ...
            this.router.navigate([`/employee/employee/employee/edit`], { queryParams: { id: response.data.employeeId } });
          }
        } else {
